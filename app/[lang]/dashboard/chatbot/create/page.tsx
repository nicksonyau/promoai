...
• Don't refuse service unless necessary`,
    ...
    sellingPoints:
      "Affordable pricing; friendly service; trusted by local customers.",
    bestSellers:
      "Top 3 best-selling items or services will be highlighted here.",
