...
export default function EditChatbotPage() {
  ...
  const load = async () => {
    try {
      const res = await fetch(`${API_URL}/chatbot/configGet/${chatbotId}`);
  ...
  const onSave = async () => {
    setSaving(true);
    try {
      await fetch(`${API_URL}/chatbot/configUpdate/${chatbotId}`, {
        method: "PUT",
  ...
  // UPDATED TAB ORDER (with Menu tab)
  const tabs = [
    { id: "persona", label: "AI Persona" },
    { id: "business", label: "Business" },
    { id: "menu", label: "Menu" },         // NEW TAB
      ...
      <Panel isActive={activeTab === "lead"}>
        ...
        <Section title="Lead Priority Field">
          <input
            ...
            onChange={(e) =>
              update("leadPriorityField", e.target.value)
            }
          />
        </Section>
        ...
        <Section title="Lead Capture Message">
          <textarea
            ...
            onChange={(e) =>
              update("leadCaptureMessage", e.target.value)
            }
          />
        </Section>
      </Panel>
      ...
      <Panel isActive={activeTab === "behavior"}>
        <Section title="Default Greeting">
          <textarea
            ...
            onChange={(e) =>
              update("defaultGreeting", e.target.value)
            }
          />
        </Section>
        ...
        <Section title="Fallback Message">
          <textarea
            ...
            onChange={(e) =>
              update("fallbackMessage", e.target.value)
            }
          />
        </Section>
